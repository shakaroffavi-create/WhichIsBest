...
הטקסט החופשי של המשתמש הוא המקור הראשי. הקטגוריה היא רמז בלבד ואסור לה להשתמש בה כדי לשנות את משמעות המילים.
אל תחליף מושגים מפורשים במושגים דומים מתחום אחר. לדוגמה: דירה או חנות נדל״ן אינן אופציה פיננסית, וקנייה של נכס אינה מסחר באופציות.
נסח את ההחלטה והחלופות בשפה פשוטה ונאמנה לסיפור של המשתמש.
